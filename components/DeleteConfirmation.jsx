...
export default function DeleteConfirmation(props) {
    ...
    const submit = () => {
        ...
        deleteData(props.hook.toDelete.file, props.hook)
            .then(toRemove => {
                props.removeEntity(props.hook.toDelete.relatedEntities.map(e => e.entity))
            ...
            {open ?
                <>
                    ...
                    <div
                        ...
                        >
                            <div
                                style={{display: props.hook.toDelete.relatedEntities > 0 ? undefined : "none"}}
